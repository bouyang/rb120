...
# Because we are invoking the serial_number getter method on an object that is not the current instance, we have to put the serial_number getter method in protected instead of private